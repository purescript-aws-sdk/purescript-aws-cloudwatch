...
module AWS.CloudWatch.Requests where
...
import AWS.CloudWatch.Types as CloudWatchTypes
...
deleteDashboards :: forall eff. CloudWatch.Service -> CloudWatchTypes.DeleteDashboardsInput -> Aff (exception :: EXCEPTION | eff) CloudWatchTypes.DeleteDashboardsOutput
deleteDashboards (CloudWatch.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "deleteDashboards"
...
describeAlarmHistory :: forall eff. CloudWatch.Service -> CloudWatchTypes.DescribeAlarmHistoryInput -> Aff (exception :: EXCEPTION | eff) CloudWatchTypes.DescribeAlarmHistoryOutput
describeAlarmHistory (CloudWatch.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "describeAlarmHistory"
...
describeAlarms :: forall eff. CloudWatch.Service -> CloudWatchTypes.DescribeAlarmsInput -> Aff (exception :: EXCEPTION | eff) CloudWatchTypes.DescribeAlarmsOutput
describeAlarms (CloudWatch.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "describeAlarms"


-- | <p>Retrieves the alarms for the specified metric. To filter the results, specify a statistic, period, or unit.</p>
describeAlarmsForMetric :: forall eff. CloudWatch.Service -> CloudWatchTypes.DescribeAlarmsForMetricInput -> Aff (exception :: EXCEPTION | eff) CloudWatchTypes.DescribeAlarmsForMetricOutput
describeAlarmsForMetric (CloudWatch.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "describeAlarmsForMetric"
...
getDashboard :: forall eff. CloudWatch.Service -> CloudWatchTypes.GetDashboardInput -> Aff (exception :: EXCEPTION | eff) CloudWatchTypes.GetDashboardOutput
getDashboard (CloudWatch.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "getDashboard"
...
getMetricStatistics :: forall eff. CloudWatch.Service -> CloudWatchTypes.GetMetricStatisticsInput -> Aff (exception :: EXCEPTION | eff) CloudWatchTypes.GetMetricStatisticsOutput
getMetricStatistics (CloudWatch.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "getMetricStatistics"
...
listDashboards :: forall eff. CloudWatch.Service -> CloudWatchTypes.ListDashboardsInput -> Aff (exception :: EXCEPTION | eff) CloudWatchTypes.ListDashboardsOutput
listDashboards (CloudWatch.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "listDashboards"
...
listMetrics :: forall eff. CloudWatch.Service -> CloudWatchTypes.ListMetricsInput -> Aff (exception :: EXCEPTION | eff) CloudWatchTypes.ListMetricsOutput
listMetrics (CloudWatch.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "listMetrics"
...
putDashboard :: forall eff. CloudWatch.Service -> CloudWatchTypes.PutDashboardInput -> Aff (exception :: EXCEPTION | eff) CloudWatchTypes.PutDashboardOutput
putDashboard (CloudWatch.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "putDashboard"
