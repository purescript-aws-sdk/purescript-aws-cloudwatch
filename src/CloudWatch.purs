...
deleteAlarms = Request.request service method  where
    service = Request.ServiceName "CloudWatch"
    method = Request.MethodName "deleteAlarms"
...
deleteDashboards = Request.request service method  where
    service = Request.ServiceName "CloudWatch"
    method = Request.MethodName "deleteDashboards"
...
describeAlarmHistory = Request.request service method  where
    service = Request.ServiceName "CloudWatch"
    method = Request.MethodName "describeAlarmHistory"
...
describeAlarms = Request.request service method  where
    service = Request.ServiceName "CloudWatch"
    method = Request.MethodName "describeAlarms"
...
describeAlarmsForMetric = Request.request service method  where
    service = Request.ServiceName "CloudWatch"
    method = Request.MethodName "describeAlarmsForMetric"
...
disableAlarmActions = Request.request service method  where
    service = Request.ServiceName "CloudWatch"
    method = Request.MethodName "disableAlarmActions"


-- | <p>Enables the actions for the specified alarms.</p>
enableAlarmActions :: forall eff. EnableAlarmActionsInput -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
enableAlarmActions = Request.request service method  where
    service = Request.ServiceName "CloudWatch"
    method = Request.MethodName "enableAlarmActions"
...
getDashboard = Request.request service method  where
    service = Request.ServiceName "CloudWatch"
    method = Request.MethodName "getDashboard"
...
getMetricStatistics = Request.request service method  where
    service = Request.ServiceName "CloudWatch"
    method = Request.MethodName "getMetricStatistics"
...
listDashboards = Request.request service method  where
    service = Request.ServiceName "CloudWatch"
    method = Request.MethodName "listDashboards"
...
listMetrics = Request.request service method  where
    service = Request.ServiceName "CloudWatch"
    method = Request.MethodName "listMetrics"
...
putDashboard = Request.request service method  where
    service = Request.ServiceName "CloudWatch"
    method = Request.MethodName "putDashboard"
...
putMetricAlarm = Request.request service method  where
    service = Request.ServiceName "CloudWatch"
    method = Request.MethodName "putMetricAlarm"
...
putMetricData = Request.request service method  where
    service = Request.ServiceName "CloudWatch"
    method = Request.MethodName "putMetricData"
...
setAlarmState = Request.request service method  where
    service = Request.ServiceName "CloudWatch"
    method = Request.MethodName "setAlarmState"
